...
#   on_arm do
#     sha256 "..."
#     url "https://github.com/mayklink/Octo-b/releases/download/v#{version}/Octob-#{version}-arm64.dmg"
#   end
#   on_intel do
#     sha256 "..."
#     url "https://github.com/mayklink/Octo-b/releases/download/v#{version}/Octob-#{version}.dmg"
#   end
...
echo "  Homebrew:       brew install --cask mayklink/Octo-b/octob"
echo ""
...
- **Phase 2 (git) succeeded but Phase 3/4 failed:** The tag exists on GitHub. Delete it with `gh release delete vX.Y.Z --repo mayklink/Octo-b -y && git push origin :refs/tags/vX.Y.Z && git tag -d vX.Y.Z`, then re-run.
