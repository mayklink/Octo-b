...
```bash
brew install --cask mayklink/octob/octob
```

Alternatively, download the `.dmg` file from [GitHub Releases](https://github.com/mayklink/Octo-b/releases).
...
```bash
brew upgrade mayklink/octob/octob
```
...
[Create an issue](https://github.com/mayklink/Octo-b/issues) on GitHub with:
- Steps to reproduce
...
[Open a discussion](https://github.com/mayklink/Octo-b/discussions) or [create a feature request](https://github.com/mayklink/Octo-b/issues/new?template=feature_request.md).
...
Not yet, but join our [GitHub Discussions](https://github.com/mayklink/Octo-b/discussions) to connect with other users.

---

Still have questions? [Open a discussion](https://github.com/mayklink/Octo-b/discussions/new?category=q-a) and we'll help!